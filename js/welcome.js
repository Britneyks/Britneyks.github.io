...
$.ajax({
    ...
    data: {
        key: 'ZQQBZ-L3WHT-QVDXK-LMEDQ-CKZMO-YGFL2',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(117.40207, 31.87993, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
