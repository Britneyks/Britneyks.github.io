!(function (t) {
    ...
    BE4S: function (t, e) {
        t.exports = {
            ...
            ok: "確定",
            now: { level: "級" },
            nowBase: { hum: "濕度", pcpn: "降水量", pres: "壓強" },
            forecast: { day1: "今天", day2: "明天", day3: "後天" },
            lifestyle: {
                cw: {
                    title: "洗車",
                    l01: "適宜",
    ...
    K5UY: function (t, e, n) {
        ...
        (s.prototype.request = function (t) {
            "string" == typeof t &&
                ...
                ((t = i.merge(r, { method: "get" }, this.defaults, t)).method =
    ...
    NHnr: function (t, e, n) {
                ...
                beforeCreate: function () {
                    ...
                    if (((t.i18n = t.i18n || (t.__i18n ? {} : null)), t.i18n))
                        if (t.i18n instanceof it) {
                            ...
                            i &&
                                u(i) &&
                                (t.i18n.messages = m(t.i18n.messages, i)),
        ...
        function O(t, e, n) {
            ...
            if ((a || l || c) && a) {
                ...
                (t._vt = t.textContent =
                    null != f
                        ? (r = p.$i18n).tc.apply(r, [a, f].concat(M(l, c)))
                        : (i = p.$i18n).t.apply(i, [a].concat(M(l, c)))),
                    (t._locale = p.$i18n.locale),
                    (t._localeMessage = p.$i18n.getLocaleMessage(
                        p.$i18n.locale
                    ));
            }
        }
        function M(t, e) {
            var n = [];
            return (
                t && n.push(t), e && (Array.isArray(e) || u(e)) && n.push(e), n
            );
        }
        function j(t) {
            j.installed = !0;
            ...
            (function (t) {
                ...
                x.mixin(_),
                x.directive("t", { bind: A, update: S, unbind: F }),
        ...
        var I = 0,
            ...
            W = 8,
            V = [];
        (V[z] = { ws: [z], ident: [3, I], "[": [q], eof: [U] }),
            (V[1] = { ws: [1], ".": [2], "[": [q], eof: [U] }),
            (V[2] = { ws: [2], ident: [3, I], 0: [3, I], number: [3, I] }),
            (V[3] = {
                ident: [3, I],
                0: [3, I],
                number: [3, I],
            ...
            (V[B] = { "'": [q, I], eof: W, else: [B, I] }),
            (V[H] = { '"': [q, I], eof: W, else: [H, I] });
            ...
            it = function (t) {
                ...
                (this._vm = null),
                    ...
                    (this._silentTranslationWarn =
                        void 0 !== t.silentTranslationWarn &&
                    ...
                    (this._exist = function (t, n) {
                        return (
                            !(!t || !n) &&
                            (!f(e._path.getPathValue(t, n)) || !!t[n])
                        );
                    }),
                    ("warn" !== this._warnHtmlInMessage &&
                        "error" !== this._warnHtmlInMessage) ||
                        Object.keys(i).forEach(function (t) {
                            e._checkLocaleMessage(
                                t,
                                e._warnHtmlInMessage,
                                i[t]
                            );
                        }),
                    this._initVM({
        ...
        (it.prototype._checkLocaleMessage = function (t, e, n) {
            ...
            (it.prototype._t = function (t, e, n, r) {
                ...
                return (
                    (c = this._warnDefault(l, t, c, r, o, "string")),
            ...
            (it.prototype._tc = function (t, e, n, r, i) {
                ...
                return (
                    ...
                    this.fetchChoice(
                        (o = this)._t.apply(o, [t, e, n, r].concat(a)),
                        i
                    )
                );
            }),
            (it.prototype.fetchChoice = function (t, e) {
                ...
                var n = t.split("|");
                return n[(e = this.getChoiceIndex(e, n.length))]
                    ? n[e].trim()
                    : t;
            }),
            ...
            (it.prototype._getNumberFormatter = function (t, e, n, r, i, o) {
                for (
                    var a = e, s = r[a], l = this._getLocaleChain(e, n), c = 0;
                    c < l.length;
                    c++
                ) {
                    var u = l[c];
            ...
            dt = {
                render: function () {
                    ...
                    return (this._self._c || t)("remote-js", {
                        attrs: { src: this.jsUrl },
                        on: { "load-js-finish": this.callback },
                    });
                },
                staticRenderFns: [],
            },
                            ...
                            value: function () {
                                var t =
                                    ...
                                    void 0 !== arguments[0]
                                        ...
                                        : 1;
                                (this.r = this.clamp(
                                    255 * (t + (this.r / 255) * (1 - 2 * t))
                                )),
                                    (this.g = this.clamp(
                                        255 * (t + (this.g / 255) * (1 - 2 * t))
                                    )),
                                    (this.b = this.clamp(
                                        255 * (t + (this.b / 255) * (1 - 2 * t))
                                    ));
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return { h: 100 * o, s: 100 * a, l: 100 * s };
                            },
                        },
                        {
                            key: "clamp",
                    ...
                    yt()(t, [
                            ...
                            value: function (t, e, n, r, i) {
                                for (
                                    ...
                                    for (
                                        ...
                                        (s[p] = Math.random() > 0.5 ? 1 : -1),
                                            (l[p] = r[p] + f * s[p]),
                                            (c[p] = r[p] - f * s[p]);
                                    for (
                                        var d = this.loss(l) - this.loss(c),
                                            h = 0;
                                        h < 6;
                                        h++
                                    ) {
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                var n = e.hsl();
                                return (
                                    Math.abs(e.r - this.target.r) +
                                    Math.abs(e.g - this.target.g) +
                                    Math.abs(e.b - this.target.b) +
        ...
        var bt = function (t) {
                var e = (function (t) {
                        ...
                        var e =
                            /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);
                        return e
                            ? [
                                  parseInt(e[1], 16),
                                  parseInt(e[2], 16),
                ...
                computed: {
                            ...
                            filter: (t =
                                ...
                                (t = (t =
                                    this.dataColor && "" != this.dataColor
                                        ? bt(this.dataColor).filter
                                        : 1 ==
                                              this.wd.pluginConfig.background ||
                                          3 == this.wd.pluginConfig.background
                                        ? bt("#FFF").filter
                                        : 2 ==
                                              this.wd.pluginConfig.background ||
                                          5 == this.wd.pluginConfig.background
                                        ? bt("#000").filter
                                        : bt("#FFF").filter).substr(
                                    8,
                                    t.length - 9
                                ))),
                        };
                    ...
                    fontColorLight: function () {
                        return this.dataColor && "" != this.dataColor
                            ...
                            ? { color: "#D5D5D5" }
                            : 2 == this.wd.pluginConfig.background ||
                              5 == this.wd.pluginConfig.background
                            ? { color: "#B8B8BA" }
                            : { color: "#D5D5D5" };
                    },
            ...
            kt = {
                render: function () {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
                    return n("div", { staticClass: "wv-lt-row" }, [
                        n("div", { staticClass: "wv-lt-col-7" }, [
                            n("div", { staticClass: "wv-lt-location" }, [
                                1 != t.cityChange
                                    ? n(
                                          "span",
                                          {
                        ...
                        t._v(" "),
                        n("div", { staticClass: "wv-lt-col-5" }, [
                            n("div", { staticClass: "wv-lt-refresh" }, [
                                n(
                                    "a",
                                    {
                                        style: t.fontColor,
                    ...
                    alarmName: function () {
                        ...
                        return (
                            this.alarm &&
                                ...
                                (t =
                                    "台风" === this.alarm.txt
                                        ? this.$t("alarm.typhoon")
                                        : "暴雨" === this.alarm.txt
                                        ? this.$t("alarm.rainstorm")
                                        : "高温" === this.alarm.txt
                                        ? this.$t("alarm.highTemperature")
                                        : "大风" === this.alarm.txt
                                        ? this.$t("alarm.gale")
                                        : "空气重污染" === this.alarm.txt
                                        ? this.$t("alarm.airPollution")
                                        : this.alarm.txt),
                            t.length > 0 &&
                                t.length < 4 &&
                                (t += this.$t("alarm.placeholder")),
                            t
                        );
                    },
                    bg: function () {
                        if (this.alarm && this.alarm.level) {
                            ...
                            return (
                                "白色" === this.alarm.level ||
                                "White" === this.alarm.level
                                    ? (t = "#888888")
                                    : "蓝色" === this.alarm.level ||
                                      "Blue" === this.alarm.level
                                    ? (t = "#157BFF")
                                    : "黄色" === this.alarm.level ||
                                      "Yellow" === this.alarm.level
                                    ? (t = "#E4C600")
                                    : "橙色" === this.alarm.level ||
                                      "Orange" === this.alarm.level
                                    ? (t = "#FF9D1E")
                                    : ("红色" !== this.alarm.level &&
                                          "Red" !== this.alarm.level) ||
                                      (t = "#E25538"),
                                { backgroundColor: t }
                            );
                        }
                    ...
                    return e(
                        "a",
                        {
                            ...
                            attrs: {
                                target: "_blank",
                                href:
                                    "http://m.weather.com.cn/malarm/alarmcontent.shtml?file=" +
                                    this.alarm.link,
                            },
                        },
                        [
                ...
                computed: {
                    ...
                    aqi: function () {
                        if (this.aqiColor && "" != this.aqiColor)
                            return { color: this.aqiColor };
                    },
                    aqiDiv: function () {
                        if (this.aqiColor && "" != this.aqiColor)
                            return { backgroundColor: this.aqiColor };
                    },
                    margin: function () {
                        if (1 == this.wd.pluginConfig.layout)
                            return { padding: "1em 0 0 0" };
                    },
                    rainPad: function () {
                    ...
                    currentAqiLevel: function () {
                        return this.current.aqi <= 50
                            ? "1"
                            : this.current.aqi <= 100
                            ? "2"
                            : this.current.aqi <= 150
                            ? "3"
                            : this.current.aqi <= 200
                            ? "4"
                            : this.current.aqi <= 300
                            ? "5"
                            : "6";
                    },
                },
            ...
            Ft = {
                render: function () {
                    ...
                    return t.current
                        ? n(
                              "div",
                              { staticClass: "wv-n-h-now", style: t.margin },
                              [
                                  n(
                                      "div",
                                      {
                                          staticClass:
                                              "wv-n-h-col-10 wv-n-h-text-left",
                                      },
                                      [
                                          n(
                                              "span",
                ...
                computed: {
                    expand: function () {
                        if (1 == this.wd.pluginConfig.layout)
                            return {
                                height:
                                    this.wd.pluginConfig.height -
                                    (this.baseFontSize +
                                        8 +
                                        0.8 * this.baseFontSize +
                                        10) -
                                    0.05 * this.wd.pluginConfig.height +
                                    "px",
                            };
                    },
                    lineColor: function () {
                        if (this.white)
                            return { borderColor: "rgba(224, 224, 224, .6)" };
                    },
                    fontColor: function () {
                        return this.dataColor && "" != this.dataColor
                            ? { color: this.dataColor }
            ...
            Mt = {
                render: function () {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
                    return n("div", { staticClass: "wv-f-forecast" }, [
                        n("div", { staticClass: "wv-f-row" }, [
                            n(
                                "div",
        ...
        var jt = {
                ...
                props: { wd: Object, baseFontSize: Number, aqiColor: String },
                computed: {
                    lineColor: function () {
                        return { borderColor: "rgba(204, 204, 204, .5)" };
                    },
                    style: function () {
                        var t = "";
                        return (
                            ...
                            [
                                n("Now", {
                                    attrs: {
                                        ...
                                        rain:
                                            t.wd.pluginConfig &&
                                            t.wd.pluginConfig.rain,
                                        current: t.wd.current,
                                        alarm: t.wd.alarm,
                                        width:
                                            t.wd.pluginConfig &&
                                            t.wd.pluginConfig.width,
                                        height:
                                            t.wd.pluginConfig &&
                                            t.wd.pluginConfig.height,
                                        wd: t.wd,
        ...
        var Et = {
                ...
                computed: {
                    ...
                    fahrenheit: function () {
                        return !(
                            !this.wd ||
                            !this.wd.pluginConfig ||
                            "2" != this.wd.pluginConfig.fahrenheit
                        );
                    },
                    baseFontSize: function () {
                        var t, e;
                        (t = this.dwidthVertical), (e = this.dheightVertical);
                        var n = -1;
                        return (n =
                            (n =
                    ...
                    bg: function () {
                        if (this.wd.pluginConfig) {
                            ...
                            if (
                                ("2" == t.background &&
                                    (this.wd.pluginConfig.backgroundColor =
                                        "#FFF"),
                                "3" == t.background &&
                                    (this.wd.pluginConfig.backgroundColor =
                                        "#313A44"),
                                ...
                                var e = "100";
                                this.wd.current &&
                                    this.wd.current.code &&
                                    (e = this.wd.current.code);
                                var n = {
                                    backgroundImage:
                                        'url("' +
                    ...
                    initCitySearch: function () {
                        (this.pArr = WIDGET.CITY_SEARCH || []),
                            this.pArr &&
                                this.pArr.length > 0 &&
                                ("zh" == this.$i18n.locale
                                    ? (this.p = this.pArr[0].zh)
                                    : "hk" == this.$i18n.locale
                                    ? (this.p = this.pArr[0].hk)
                                    : (this.p = this.pArr[0].en));
                    },
                    changeCityId: function () {
                        this.a &&
                            "" !== this.a &&
                            ((this.$parent.wd.cityId = this.a),
                ...
                watch: {
                        ...
                        for (var n = 0; n < this.pArr.length; n++)
                            if (
                                ...
                                (this.cArr = this.pArr[n].children),
                                    "zh" == this.$i18n.locale
                                        ? (this.c = this.pArr[n].children[0].zh)
                                        : "hk" == this.$i18n.locale
                                        ? (this.c = this.pArr[n].children[0].hk)
                                        : (this.c =
                                              this.pArr[n].children[0].en),
                    ...
                    a: function (t) {
                        for (var e = 0; e < this.aArr.length; e++)
                            if (this.aArr[e].id == t) {
                                "zh" == this.$i18n.locale
                                    ? (this.aName = this.aArr[e].zh)
                                    : "hk" == this.$i18n.locale
                                    ? (this.aName = this.aArr[e].hk)
                                    : (this.aName = this.aArr[e].en);
                                break;
                            }
                    },
                },
            ...
            Dt = {
                render: function () {
                    ...
                    return n("div", [
                        n(
                            "div",
                            { style: t.bg, attrs: { id: "weather-view-he" } },
                            [
                                n("ViewVertical", {
                                ...
                                t._v(" "),
                                this.wd.pluginConfig.cityChange
                                    ? n("remote-js", {
                                          attrs: {
                                              "js-url":
                                                  "https://widget-s.qweather.net/js/plugin/190516/city.js",
                                              "js-load-call-back":
                                                  t.initCitySearch,
                                          },
                                      })
        ...
        var It = n("C7Lr")(
            ...
            Nt = {
                props: { type: String, wd: Object, id: Number },
                computed: {
                    formatCity: function () {
                        var t = this.wd.city;
                        return (
                            this.wd.city &&
                                this.wd.city.length > 10 &&
                                (t = this.wd.city.substr(0, 8) + "..."),
                            (t = t.charAt(0).toUpperCase() + t.slice(1))
                        );
                    },
                    svgStyle: function () {
                        if (
                            this.wd.pluginConfig &&
                            this.wd.pluginConfig.alertIconSize
                        )
                            return {
                                width:
                                    this.wd.pluginConfig.alertIconSize + "px",
                                height:
                                    this.wd.pluginConfig.alertIconSize + "px",
                            };
                    },
                    imgStyle: function () {
                        if (
                            this.wd.pluginConfig &&
                            this.wd.pluginConfig.weatherIconSize
                        )
                            return {
                                width:
                                    this.wd.pluginConfig.weatherIconSize + "px",
                                height:
                                    this.wd.pluginConfig.weatherIconSize + "px",
                            };
                    },
                    cityFont: function () {
                        ...
                        return (
                            this.wd.pluginConfig &&
                                this.wd.pluginConfig.citySize &&
                                (t.fontSize =
                                    this.wd.pluginConfig.citySize + "px"),
                            this.wd.pluginConfig &&
                                this.wd.pluginConfig.cityColor &&
                                (t.color = this.wd.pluginConfig.cityColor),
                            (t.color && "" != t.color) ||
                                (this.wd &&
                                this.wd.pluginConfig &&
                                ("2" === this.wd.pluginConfig.background ||
                    ...
                    tmpFont: function () {
                        ...
                        return (
                            this.wd.pluginConfig &&
                                this.wd.pluginConfig.tmpSize &&
                                (t.fontSize =
                                    this.wd.pluginConfig.tmpSize + "px"),
                            this.wd.pluginConfig &&
                                this.wd.pluginConfig.tmpColor &&
                                (t.color = this.wd.pluginConfig.tmpColor),
                            (t.color && "" != t.color) ||
                                (this.wd &&
                                this.wd.pluginConfig &&
                                ("2" === this.wd.pluginConfig.background ||
                    ...
                    aqiLevelColor: function () {
                        ...
                        return (
                            this.wd &&
                                this.wd.current &&
                                (this.wd.pluginConfig.aqiColor
                                    ? (t.color = this.wd.pluginConfig.aqiColor)
                                    : this.wd.current.aqi <= 50
                                    ? (t.color = "#94CE6F")
                                    : this.wd.current.aqi <= 100
                                    ? (t.color = "#E4C600")
                                    : this.wd.current.aqi <= 150
                                    ? (t.color = "#E59C3B")
                                    : this.wd.current.aqi <= 200
                                    ? (t.color = "#C76464")
                                    : this.wd.current.aqi <= 300
                                    ? (t.color = "#8A4DAA")
                                    : (t.color = "#BF2762"),
                                this.wd.pluginConfig.aqiSize &&
                                    (t.fontSize =
                                        this.wd.pluginConfig.aqiSize + "px")),
                            t
                        );
                    },
                    alarmLevel: function () {
                        ...
                        return (
                            "白色" === this.wd.alarm.level ||
                            "White" === this.wd.alarm.level
                                ? (t = "#DDD")
                                : "蓝色" === this.wd.alarm.level ||
                                  "Blue" === this.wd.alarm.level
                                ? (t = "#0074D9")
                                : "黄色" === this.wd.alarm.level ||
                                  "Yellow" === this.wd.alarm.level
                                ? (t = "#FFDC00")
                                : "橙色" === this.wd.alarm.level ||
                                  "Orange" === this.wd.alarm.level
                                ? (t = "#FF851B")
                                : ("红色" !== this.wd.alarm.level &&
                                      "Red" !== this.wd.alarm.level) ||
                                  (t = "#FF4136"),
                            t
                        );
                    },
                    fahrenheit: function () {
                        return !(
                            !this.wd ||
                            !this.wd.pluginConfig ||
                            "1" !== this.wd.pluginConfig.fahrenheit
                        );
                    },
                    baseFontSize: function () {
                        return this.width / 190 <= this.height / 40
                            ? (12 * this.width) / 190
                            : (12 * this.height) / 40;
                    },
                },
            ...
            Pt = {
                render: function () {
                    ...
                    return "alert-icon" == this.type &&
                        this.wd.alarm &&
                        "" != this.wd.alarm.level
                        ? n("div", { staticClass: "s-sticker-alarm" }, [
                              n(
                                  "svg",
                                  {
                                      style: t.svgStyle,
                        ...
                        : "weather-icon" == this.type
                        ? n("div", { staticClass: "s-sticker-cond" }, [
                              n("img", {
                                  style: t.imgStyle,
                                  attrs: {
                                      src:
                        ...
                        ? n(
                              ...
                              [t._v(t._s(this.wd.current.aqiTxt))]
                          )
                        : n("div");
                },
                staticRenderFns: [],
        ...
        var Rt = {
                ...
                computed: {
                    ...
                    floatShortStyle: function () {
                        ...
                        return (
                            this.wd &&
                                ...
                                (1 == this.wd.pluginConfig.shadow &&
                                    "true" ==
                                        this.wd.pluginConfig.position.fixed &&
                                    (t.boxShadow =
                                        "0 2px 4px rgba(0, 0, 0, .38)"),
                                "2" == this.wd.pluginConfig.background
                                    ? (t.backgroundColor = "#FFFFFF")
                                    : "3" == this.wd.pluginConfig.background
                                    ? (t.backgroundColor = "#313A44")
                                    : "3" == this.wd.pluginConfig.background
                                    ? (t.backgroundColor = "#313A44")
                                    : "4" == this.wd.pluginConfig.background
                                    ? (t.backgroundColor =
                                          this.wd.pluginConfig.backgroundColor)
                                    : "5" == this.wd.pluginConfig.background
                            ...
                            this.wd.pluginConfig.padding &&
                                (t.padding = this.wd.pluginConfig.padding),
                            this.wd.pluginConfig.borderRadius &&
                                (t.borderRadius =
                                    this.wd.pluginConfig.borderRadius + "px"),
                            t
                        );
                    },
                    position: function () {
                        ...
                        return (
                            e && e.position && "true" == e.position.fixed
                                ? ((t.position = "absolute"),
                                  e.position.top &&
                                      (t.top = e.position.top + "px"),
                                  e.position.right &&
                                      (t.right = e.position.right + "px"),
                                  e.position.bottom &&
                                      (t.bottom = e.position.bottom + "px"),
                                  e.position.left &&
                                      (t.left = e.position.left + "px"))
                                : (t.position = "relative"),
                            t
                        );
                    },
                    fadePosition: function () {
                        ...
                        if (
                            this.wd &&
                            this.wd.pluginConfig &&
                            this.wd.pluginConfig.position
                        ) {
                            var i = {};
                            return (
                                e > 280
                                    ? (i.top = t.offsetHeight + 5 + "px")
                                    : n > 280
                                    ? (i.bottom = t.offsetHeight + 5 + "px")
                                    : (i.top = t.offsetHeight + 5 + "px"),
                                r <= 0.5 ? (i.left = "0px") : (i.right = "0px"),
                                i
                            );
                        }
                        return { top: t.offsetHeight + 5 + "px", left: "0px" };
                    },
                    left: function () {
                ...
                methods: {
                    ...
                    getCityId: function (t) {
                        ...
                        ft.a
                            .get(
                                "https://search.heweather.net/find?key=" +
                                    this.wd.pluginConfig.key +
                                    "&group=cn&lang=" +
                                    e.$i18n.locale +
                                    "&location=" +
                                    t
                                ...
                                if ("ok" === t.data.HeWeather6[0].status) {
                                    ...
                                    for (var r in n) {
                                        (e.wd.city = n[r].location),
                                            (e.wd.cityId = n[r].cid.substr(
                                                2,
                                                9
                                            ));
                                        break;
                                    }
                                } else (e.wd.city = "合肥"), (e.wd.cityId = "101220101");
                    ...
                    parseStickerData: function (t) {
                        ...
                        t.now &&
                            ...
                            e.fahrenheit
                                ? (e.wd.current.tmp =
                                      (9 * t.now.tmp) / 5 + 32 + "℉")
                                : (e.wd.current.tmp = t.now.tmp + "°C"),
                            (e.wd.current.code = t.now.cond_code),
                            (e.wd.current.txt = t.now.cond_txt)),
                            t.air_now_city &&
                                ((e.wd.current.aqi = t.air_now_city.aqi),
                                (e.wd.current.aqiTxt = t.air_now_city.qlty
                                    .replace("污染", "")
                                    .replace("汙染", "")
                                    .replace(" polluted", "")
                                    .replace(" pollution", "")),
                                e.wd.current.aqiTxt.length > 10 &&
                                    (e.wd.current.aqiTxt =
                                        e.wd.current.aqiTxt.substr(0, 9) +
                                        "...")),
                            t.rain && (e.wd.current.rain = t.rain.txt),
                            t.alarm &&
                            t.alarm.length > 0 &&
                            !e.wd.pluginConfig.demo
                                ? ((e.wd.alarm = {}),
                                  (e.wd.alarm.txt = t.alarm[0].type),
                                  (e.wd.alarm.level = t.alarm[0].level))
                                : e.wd.pluginConfig.demo &&
                                  ("en" == e.$i18n.locale
                                      ? (e.wd.alarm.txt = "Rainstorm")
                                      : (e.wd.alarm.txt = "暴雨"),
                    ...
                    parseViewData: function (t) {
                        ...
                        if (
                            (t.now &&
                                ((e.wd.view.current = {}),
                                e.fahrenheit
                                    ? (e.wd.view.current.tmp =
                                          (9 * t.now.tmp) / 5 + 32 + "")
                                    : (e.wd.view.current.tmp = t.now.tmp + ""),
                                (e.wd.view.current.code = t.now.cond_code),
                                (e.wd.view.current.txt = t.now.cond_txt)),
                            t.air_now_city &&
                                ((e.wd.view.current.aqi = t.air_now_city.aqi),
                                (e.wd.view.current.aqiTxt = t.air_now_city.qlty
                                    .replace("污染", "")
                                    .replace("汙染", "")
                                    .replace(" polluted", "")
                                    .replace(" pollution", "")),
                                e.wd.view.current.aqiTxt.length > 10 &&
                                    (e.wd.view.current.aqiTxt =
                                        e.wd.view.current.aqiTxt.substr(0, 9) +
                                        "...")),
                            ...
                            for (
                                var n =
                                        t.daily_forecast.length > 7
                                            ? 7
                                            : t.daily_forecast.length,
                                    r = (new Date().getHours(), 0);
                                r < n;
                                r++
                            ) {
                        ...
                        if (
                            ...
                            !e.wd.pluginConfig.demo
                                ...
                                : e.wd.pluginConfig.demo &&
                                  ("en" == e.$i18n.locale
                                      ? (e.wd.view.alarm.txt = "Rainstorm")
                                      : (e.wd.view.alarm.txt = "暴雨"),
                                  (e.wd.view.alarm.level = "Orange")),
                            t.air_forecast &&
                                t.air_forecast &&
                                t.air_forecast.length > 0)
                        ) {
                            var s =
                                e.wd.view.forecast.length > 3
                                    ? 3
                                    : e.wd.view.forecast.length;
                            s =
                                t.air_forecast.length >= s
                                    ? s
                                    : t.air_forecast.length;
                            for (var l = 0; l < s; l++) {
                                var c = t.air_forecast[l];
                                (e.wd.view.forecast[l].aqi = c.aqi),
                                    (e.wd.view.forecast[l].aqiTxt = c.qlty
                                        .replace("污染", "")
                                        .replace("汙染", "")
                                        .replace(" polluted", "")
                                        .replace(" pollution", ""));
                    ...
                    getWeatherData: function () {
                        ...
                        ft.a
                            ...
                            .then(function (e) {
                                ...
                                n &&
                                    "ok" === n.status &&
                                    (t.parseStickerData(n), t.parseViewData(n));
                            })
                            .catch(function (t) {});
                    },
                            ...
                            for (var n = 0; n < t.length; n++)
                                switch (t[n]) {
                                    case "0":
                                        ...
                                        break;
                                    case "1":
                                        e.push({ type: "city-name" });
                                        break;
                                    case "2":
                                        e.push({ type: "weather-icon" });
                                        break;
                                    case "3":
                                        e.push({ type: "alert-icon" });
                                        break;
                                    case "4":
                                        e.push({ type: "aqi-level" });
                                }
                        return e;
                    },
                    getFromParams: function () {
                        ...
                        return {
                            ...
                            cityChange:
                                null != t.$utils.getUrlKey("city") ? "0" : "1",
                            ...
                            weatherIconSize:
                                t.$utils.getUrlKey("weatherIconSize"),
                            ...
                            contentAlign: {
                                horizontal:
                                    t.$utils.getUrlKey("horizontal") ||
                                    "center",
                                vertical:
                                    t.$utils.getUrlKey("vertical") || "middle",
                            },
                            modules: [],
                            md: t.$utils.getUrlKey("modules") || "01234",
                            key: t.$utils.getUrlKey("key"),
                            demo:
                                !!t.$utils.getUrlKey("demo") &&
                                "true" == t.$utils.getUrlKey("demo"),
                        };
                    },
                    ...
                    getPluginConfig: function (t) {
                        ...
                        ((e = WIDGET.CONFIG
                            ? this.getFromObject()
                            : this.getFromParams()).modules = this.parseModules(
                            e.md
                        )),
                    ...
                    getData: function () {
                        ...
                        this.getPluginConfig(function () {
                            1 == t.wd.pluginConfig.cityChange
                                ? t.initAMap()
                                : t.getCityId(t.wd.pluginConfig.city);
                        });
                    },
                },
                watch: {
                ...
                render: function () {
                    ...
                    return n(
                        ...
                        [
                            ...
                            t._v(" "),
                            this.wd.current && "" != this.wd.current.code
                                ? n(
                                      "div",
                                      {
                                ...
                                : t._e(),
                            t._v(" "),
                            this.wd.view.current &&
                            "" != this.wd.view.current.forecast
                                ? n(
                                      "div",
                                      {
                                          on: {
        ...
        var Bt = new at({
            locale: "zh",
            messages: { zh: n("hLMD"), hk: n("BE4S"), en: n("FQqZ") },
        });
        (r.a.prototype.CONFIG = Object({
            ...
            new r.a({
                el: "#he-plugin-simple",
                i18n: Bt,
                data: { eventBus: new r.a() },
                components: { WeatherView: qt },
    ...
    RUR6: function (t, e, n) {
        var r = n("Wtcz");
        r(r.S + r.F * !n("uoC7"), "Object", { defineProperty: n("hHwa").f });
    },
    SKbP: function (t, e) {},
    V0EG: function (t, e) {
        var n,
    ...
    "bBK/": function (t, e, n) {
        t.exports =
            ...
            !n("2gH+")(function () {
                return (
                    7 !=
                    Object.defineProperty(n("P/bz")("div"), "a", {
                        get: function () {
                            return 7;
                        },
                    }).a
    ...
    hLMD: function (t, e) {
        t.exports = {
            ...
            ok: "确定",
            now: { level: "级" },
            nowBase: { hum: "湿度", pcpn: "降水量", pres: "大气压强" },
            forecast: { day1: "今天", day2: "明天", day3: "后天" },
            lifestyle: {
                cw: {
                    title: "洗车",
                    l01: "适宜",
        ...
        (function (t) {
            ...
            function jt(t, e) {
                ...
                for (
                    var n,
                        r,
                        i,
                        o = ct ? Reflect.ownKeys(e) : Object.keys(e),
                        a = 0;
                    a < o.length;
                    a++
                )
            ...
            function Nt(t, e, n) {
                if (
                    ...
                    !e._base &&
                        (e.extends && (t = Nt(t, e.extends, n)), e.mixins))
                )
            ...
            function Le(t, e, r, i, a) {
                ...
                (this.data = t),
                    ...
                    (this.slots = function () {
                        return (
                            l.$slots ||
                                ve(t.scopedSlots, (l.$slots = de(r, i))),
                            l.$slots
                        );
                    }),
            ...
            function We(t, e) {
                return (
                    (t.__esModule ||
                        (ct && "Module" === t[Symbol.toStringTag])) &&
                        (t = t.default),
                    s(t) ? e.extend(t) : t
                );
            }
            ...
            function Xe(t, e, n) {
                (He = t), se(e, n || {}, Ge, Ze, Je, t), (He = void 0);
            }
            var Ye = null;
            function Qe(t) {
                var e = Ye;
            ...
            var gn = { enumerable: !0, configurable: !0, get: M, set: M };
            function mn(t, e, n) {
                (gn.get = function () {
                    return this[e][n];
                }),
                ...
                t.prototype._init = function (t) {
                    ...
                    (e._uid = xn++),
                        ...
                        t && t._isComponent
                            ...
                            : (e.$options = Nt($n(e.constructor), t || {}, e)),
                        (e._renderProxy = e),
                        (e._self = e),
                        (function (t) {
                            var e = t.$options,
            ...
            function mr(t, e) {
                ...
                if (
                    ...
                    var o,
                        ...
                        l = t.data.attrs || {},
                        c = e.data.attrs || {};
                    for (o in (i(c.__ob__) && (c = e.data.attrs = T({}, c)), c))
                        (a = c[o]), l[o] !== a && yr(s, o, a);
                    for (o in ((X || Q) &&
                        c.value !== l.value &&
                        yr(s, "value", c.value),
                    l))
            ...
            function Dr(t, e, n, r, i) {
                (i
                    ...
                    : t.attrs || (t.attrs = [])
                ).push(Ur({ name: e, value: n, dynamic: i }, r)),
                    (t.plain = !1);
            }
            function Ir(t, e, n, r) {
                (t.attrsMap[e] = n),
                    t.attrsList.push(Ur({ name: e, value: n }, r));
            }
                ...
                (i = i || n).right
                    ...
                    : i.middle &&
                      (l
                          ? (e = "(" + e + ")==='click'?'mouseup':(" + e + ")")
                          : "click" === e && (e = "mouseup")),
                    i.capture && (delete i.capture, (e = Pr("!", e, l))),
                    i.once && (delete i.once, (e = Pr("~", e, l))),
                    i.passive && (delete i.passive, (e = Pr("&", e, l))),
                    i.native
                        ? (delete i.native,
                          (c = t.nativeEvents || (t.nativeEvents = {})))
                        : (c = t.events || (t.events = {}));
                var u = Ur({ value: r.trim(), dynamic: l }, s);
                i !== n && (u.modifiers = i);
                var f = c[e];
                Array.isArray(f)
                    ? o
                ...
                if (!r(t.data.domProps) || !r(e.data.domProps)) {
                    ...
                    for (n in l) {
                        ...
                        if ("value" === n && "PROGRESS" !== a.tagName) {
                            ...
                            (ai =
                                ai || document.createElement("div")).innerHTML =
                                "<svg>" + o + "</svg>";
            ...
            function $i(t) {
                if (t) {
                    if ("object" == typeof t) {
                        var e = {};
                        return (
                            !1 !== t.css && T(e, Ai(t.name || "v")), T(e, t), e
                        );
                    }
            ...
            Si &&
                (void 0 === window.ontransitionend &&
                    ...
                    ((Oi = "WebkitTransition"), (Mi = "webkitTransitionEnd")),
            ...
            var ko,
                ...
                Oo =
                    /^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,
                Mo = "[a-zA-Z_][\\-\\.0-9_a-zA-Z" + q.source + "]*",
                jo = "((?:" + Mo + "\\:)?" + Mo + ")",
                Lo = new RegExp("^<" + jo),
                Eo = /^\s*(\/?)>/,
                Do = new RegExp("^<\\/" + jo + "[^>]*>"),
                        ...
                        if ("template" === t.tag) {
                            ...
                            if (s) {
                                ...
                                (p.slotTarget = u),
                                    ...
                                    (p.children = t.children.filter(function (
                                        t
                                    ) {
                                        if (!t.slotScope)
                                            return (t.parent = p), !0;
            ...
            var Aa,
                ...
                Fa = {
                    ...
                    directives: {
                        ...
                        text: function (t, e) {
                            e.value &&
                                Er(t, "textContent", "_s(" + e.value + ")", e);
                        },
                        html: function (t, e) {
                            e.value &&
                                Er(t, "innerHTML", "_s(" + e.value + ")", e);
                        },
                    },
                    isPreTag: function (t) {
                        return "pre" === t;
            ...
            function Ja(t) {
                return (
                    1 === t.type && ("slot" === t.tag || t.children.some(Ja))
                );
            }
            function Xa(t, e) {
    ...
    liLe: function (t, e, n) {
        t.exports = { default: n("zhwF"), __esModule: !0 };
    },
    nFvV: function (t, e, n) {
        "use strict";
        var r = n("dZqa"),
